...
\begin{document}
    \begin{tikzpicture}[scale=5.3,cap=round,>=latex]
        ...
        \draw[->, color=blue] (-1.5cm,0cm) -- (1.5cm,0cm) node[right,fill=white] {$x$};
        \draw[->, color=blue] (0cm,-1.5cm) -- (0cm,1.5cm) node[above,fill=white] {$y$};
        ...
        \node[fill=white] (jy1) at (0,0.5) {$\frac12$};
        \node[fill=white] (jy2) at (0,0.707) {$\frac{\sqrt{2}}{2}$};
        \node[fill=white] (jy3) at (0,0.866) {$\frac{\sqrt{3}}{2}$};
        ...
        \node[fill=white] (jx1) at (0.5,0) {$\frac12$};
        \node[fill=white] (jx2) at (0.707,0) {$\frac{\sqrt{2}}{2}$};
        \node[fill=white] (jx3) at (0.866,0) {$\frac{\sqrt{3}}{2}$};
        ...
        \node[shape=circle,fill=white] (ny1) at (0,-0.5) {$-\frac12$};
        \node[fill=white] (ny2) at (0,-0.707) {$-\frac{\sqrt{2}}{2}$};
        \node[fill=white] (ny3) at (0,-0.866) {$-\frac{\sqrt{3}}{2}$};
        ...
        \node[fill=white] (nx1) at (-0.5,0) {$-\frac12$};
        \node[fill=white] (nx2) at (-0.707,0) {$-\frac{\sqrt{2}}{2}$};
        \node[fill=white] (nx3) at (-0.866,0) {$-\frac{\sqrt{3}}{2}$};
